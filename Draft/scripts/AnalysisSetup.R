...
#Create data subset of only organic samples by excluding samples with no pesticide related claims (i.e., conventional) for both 2014 and 2004, respectively.
...
#Create data subset of only conventional samples by only including samples with no pesticide related claims (i.e., conventional) for both 2014 and 2004, respectively.
...
#Create data subset of only results where a residue was detected by excluding rows with null for CONCEN (residue concentration).
...
#Create data subset of only detected residue test results for organic samples by excluding rows with null for CONCEN (residue concentration) from the previously created organic results subsets.
