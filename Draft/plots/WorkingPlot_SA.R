...
Avg_No_Grade_Plot <- ggplot(stat_14_grade, aes(x=rownames(stat_14_grade), y=`Avg # of Pesticides`, fill=stat_14_grade$`Avg # of Pesticides`)) + geom_bar(stat="identity", width=.8) + xlab("Apple Grade") + ylab("Avg. Number of Pesticides") + ggtitle("Average Number of Pesticides by Grade") + scale_fill_gradient("Samples \n in Grade", low="#132B43", high="#56B1F7")
